...
#  
#
#  Created by Ranjana Rajendran on 12/12/12.
...
climateginiarearectanglesthreshold<-read.table(args[6], header=TRUE, col.names=c("V1","V2","V3","V4","V5","V6","V7","V8","V9","V10","V11"))
...
for(i in 1:maxu){
  ...
  for(j in 1:num){
    if(V11[j]==uvalues3[i] && V10[j] != 1){
      ...
      textxy(rectlx[j] + 0.45, rectly[j] + 0.3, V11[j], cx = 0.1, dcol = "black")
