...
java -classpath $CLASSPATH ibm.irl.internship.climate.climategridginineighbor $path/data $GINITHRESHOLDDIRECTORY
...
rfile=$path/Rscripts/tempNAgridbpair.R
...
for i in {1..4} ; do
    ...
    nameofplot="giniareabpairNAtop"$koftopk"case"$i".pdf"
