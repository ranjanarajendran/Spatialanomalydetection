...
public class precisionrecallsatscannormalrm {
	...
	public static void main(String args[]) throws IOException{
		...
		Double radiusmult = Double.parseDouble(args[2]);
	...
	//		}
		...
		FileInputStream fstream4 = new FileInputStream(infilepath+"/"+"NAsatscanneighborresult"+radiusmult+".txt");
		...
		System.out.println("Total number of cricles"+satscancircles.size());
		
		ListIterator<String> itc = satscancircles.listIterator();
		
		File newfilepr = new File(outfilepath+"/precisionrecall"+radiusmult+".txt");
        ...
        // For top k circles find precision and recall until recall is 1. Write to file.
		
		for(int k = 10; k < satscancircles.size() && recall.doubleValue() < 1.0; k=k+10){
			...
			File newfile4 = new File(outfilepath+"/seattlesatscannormhighlowrectangles"+k);
			...
			top10giniwriter.close(); // Actually topk
