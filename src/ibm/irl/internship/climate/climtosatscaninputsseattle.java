...
public class climtosatscaninputsseattle {
	...
	public static void main(String args[]) throws IOException{
		...
		//String casefilename = "NAtemplatlongcasnorm.cas";
		String geofilename = "NAtemplatlonggeoseattle.geo";
		//String geofilename = "NAtemplatlonggeo.geo";
		
		String casefilename2= "NAtemplatlongberncasseattle.cas";
		//String casefilename2= "NAtemplatlongberncas.cas";
		
		String ctlfilename = "NAtemplatlongberctlseattle.ctl";
		//String ctlfilename = "NAtemplatlongberctl.ctl";
		...
		try{FileInputStream fstream = new FileInputStream(infilepath+"/"+infilename);
            ...
            while((currentline = br.readLine())!=null){
                ...
                String geoentry = locid.toString() + "	" +current[4].toString() + "	" + current[3].toString() + "\n";
                
                if(Double.parseDouble(current[2]) <= 0.0 || Double.parseDouble(current[2]) >= 23.0){
                    casevalue=1;
                    ctlvalue = 0;
                    casecount ++;
                }
